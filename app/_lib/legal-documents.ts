...
export function createLegalDocuments(config: LegalSiteConfig): {
    ...
    const polishUpdatedDate = "Ostatnia aktualizacja: 20 lipca 2026 r., 18:00 CEST (UTC+02:00, Europe/Warsaw)"
    const englishUpdatedDate = "Last updated: July 20, 2026, 18:00 CEST (UTC+02:00, Europe/Warsaw)"
    ...
    const pl: LegalDocuments = {
        privacy: {
            ...
            intro: [
                ...
                "Obejmuje ona konta, postęp górski, treści użytkowników, publiczne profile i rankingi, analitykę korzystania z produktu, diagnostykę awarii, zakupy w App Store oraz zamówienia fizycznych pinów.",
            ],
            sections: [
                section(
                ...
                section(
                    ...
                    list(
                        ...
                        "lokalne użycie bieżącej lokalizacji i biblioteki zdjęć oraz przekazanie współrzędnych lub środka mapy do wyszukania wybranego przez użytkownika punktu odbioru: wykonanie umowy, art. 6 ust. 1 lit. b RODO; komunikat iOS o uprawnieniu jest kontrolą systemową, a nie samodzielną podstawą prawną,",
                ...
                section(
                    ...
                    paragraph("Strona 28gor.app używa localStorage do zapamiętania języka, motywu i ustawień interfejsu. Aplikacja iOS zawiera też SDK Meta służący do udostępniania na Facebooku i inicjalizuje go przy uruchomieniu aplikacji. SDK może przekazywać Meta podstawowe zdarzenia aktywacji i użycia, zdarzenia związane z udostępnianiem, identyfikatory aplikacji lub urządzenia oraz dane techniczne i diagnostyczne. Zakres zależy od konfiguracji SDK, ustawień iOS i działania użytkownika. Meta może przetwarzać te dane na własnych zasadach, w tym do analityki, pomiaru reklam lub łączenia danych między usługami, jeżeli zezwalają na to właściwe uprawnienia i prawo."),
                ),
                section(
                    "Odbiorcy danych",
                    list(
        ...
        terms: {
            ...
            sections: [
                ...
                section(
                    ...
                    paragraph("Aplikacja zawiera SDK Meta służący do udostępniania na Facebooku i inicjalizuje go przy uruchomieniu. Szczegółowy zakres przetwarzania danych lokalizacji, zdjęć, urządzenia i danych przez zewnętrznych dostawców opisuje Polityka prywatności."),
                ),
                section(
                ...
                section(
                    ...
                    paragraph("Zweryfikowany użytkownik może rozpocząć trwałe usunięcie konta w ustawieniach aplikacji. Usunięcie obejmuje usunięcie lub anonimizację danych zgodnie z Polityką prywatności. Ograniczone kopie zapasowe, wewnętrzne rekordy rankingowe i moderacyjne, rejestry StoreKit oraz dokumentacja zamówień mogą pozostać przez okres potrzebny do zapewnienia spójności rankingu, obsługi zgłoszeń lub uprawnień, zapobiegania nadużyciom, wykonania obowiązków prawnych albo obrony roszczeń."),
            ...
            sections: [
                ...
                section(
                    ...
                    list(
                        ...
                        "using current location and the photo library locally and sending coordinates or a map center to find a pickup point selected by the user: performance of a contract, Article 6(1)(b) GDPR; the iOS permission prompt is a system control, not a separate legal basis,",
                ...
                section(
                    ...
                    paragraph("28gor.app uses localStorage to remember language, theme, and interface settings. The iOS app also includes the Meta SDK for Facebook sharing and initializes it when the app launches. The SDK may send Meta basic activation and usage events, sharing-related events, app or device identifiers, and technical and diagnostic data. The scope depends on SDK configuration, iOS settings, and the user's action. Meta may process this data under its own rules, including for analytics, ad measurement, or combining data across services where the relevant permissions and law allow it."),
                ),
                section(
                    "Recipients",
                    list(
        ...
        terms: {
            ...
            sections: [
                ...
                section(
                    ...
                    paragraph("The app includes the Meta SDK for Facebook sharing and initializes it at launch. The Privacy Policy describes the detailed processing of location, photos, device data, and data handled by third-party providers."),
                ),
                section(
