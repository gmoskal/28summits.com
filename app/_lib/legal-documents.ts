...
export function createLegalDocuments(config: LegalSiteConfig): {
    ...
    const polishUpdatedDate = "Ostatnia aktualizacja: 16 lipca 2026 r., 22:22 CEST (UTC+02:00, Europe/Warsaw)"
    const englishUpdatedDate = "Last updated: July 16, 2026, 22:22 CEST (UTC+02:00, Europe/Warsaw)"
        ...
        privacy: {
            ...
            sections: [
                ...
                section(
                    ...
                    paragraph("Nazwa publiczna, avatar, komentarz, dostęp do lokalizacji, aparatu, biblioteki zdjęć i powiadomień są opcjonalne. Odmowa lokalizacji wyłącza funkcje odległości, potwierdzania obecności przy szczycie i automatycznego wyszukania punktów odbioru w pobliżu bieżącej pozycji; punkt można nadal wyszukać ręcznie. Odmowa dostępu do zdjęć lub aparatu wyłącza tylko właściwy sposób dodawania zdjęcia, a odmowa powiadomień wyłącza powiadomienia push. Pozostałe funkcje działają niezależnie, o ile nie wymagają tej konkretnej informacji."),
                ),
                section(
