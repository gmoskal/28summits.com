        ...
        terms: {
            ...
            sections: [
                ...
                section(
                    ...
                    paragraph(`Komentarze i inne treści można zgłaszać za pomocą dostępnych funkcji w aplikacji. Treści, profile, konta lub wpisy rankingowe można również zgłaszać na ${config.contactEmail}, podając informacje potrzebne do odnalezienia zgłoszonego elementu.`),
                ),
                section(
        ...
        terms: {
            ...
            sections: [
                ...
                section(
                    ...
                    paragraph(`Comments and other content can be reported using the reporting features available in the app. Content, profiles, accounts, or leaderboard entries may also be reported by emailing ${config.contactEmail} and providing enough information to identify the reported item.`),
                ),
                section(
